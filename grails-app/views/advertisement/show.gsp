...
<html>
    ...
    <body>
        ...
        <div id="show-advertisement" class="content scaffold-show" role="main">
            ...
            <f:display bean="advertisement" />
            <g:form resource="${this.advertisement}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.advertisement}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
